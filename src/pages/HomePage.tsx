          ...
          >
            <div className="bg-white rounded-xl shadow-xl p-6">
              ...
              <div className="mt-6 p-4 bg-green-50 rounded-lg">
                <h3 className="font-semibold text-green-900 mb-2">Keyboard Shortcuts</h3>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-2 text-sm text-green-700">
                  <div><kbd className="bg-white px-1 rounded border border-green-200">0-9</kbd> Numbers</div>
                  <div><kbd className="bg-white px-1 rounded border border-green-200">+</kbd> Addition</div>
                  <div><kbd className="bg-white px-1 rounded border border-green-200">-</kbd> Subtraction</div>
                  <div><kbd className="bg-white px-1 rounded border border-green-200">*</kbd> Multiplication</div>
                  <div><kbd className="bg-white px-1 rounded border border-green-200">/</kbd> Division</div>
                  <div><kbd className="bg-white px-1 rounded border border-green-200">.</kbd> Decimal</div>
                  <div><kbd className="bg-white px-1 rounded border border-green-200">Enter</kbd> Equals</div>
                  <div><kbd className="bg-white px-1 rounded border border-green-200">Esc</kbd> Clear All</div>
                </div>
              </div>
            </div>
          </motion.div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="text-center p-4 bg-green-50 rounded-lg">
              <div className="text-3xl font-mono font-bold text-green-600 mb-2">π</div>
              <div className="text-sm text-green-700">Pi (3.14159...)</div>
              <div className="text-xs text-green-500">Ratio of circumference to diameter</div>
            </div>
            <div className="text-center p-4 bg-green-50 rounded-lg">
              <div className="text-3xl font-mono font-bold text-green-600 mb-2">e</div>
              <div className="text-sm text-green-700">Euler's Number (2.71828...)</div>
              <div className="text-xs text-green-500">Base of natural logarithm</div>
            </div>
            <div className="text-center p-4 bg-green-50 rounded-lg">
              <div className="text-3xl font-mono font-bold text-green-600 mb-2">√</div>
              <div className="text-sm text-green-700">Square Root</div>
              <div className="text-xs text-green-500">Find the principal square root</div>
            </div>
          </div>
        </motion.div>
      </div>
