            ...
            <div className="bg-white rounded-xl shadow-xl p-6">
              ...
              <div className="mt-6 p-4 bg-gray-50 rounded-lg">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-2 text-sm text-gray-600">
                  <div><kbd className="bg-white px-1 rounded">0-9</kbd> Numbers</div>
                  <div><kbd className="bg-white px-1 rounded">+</kbd> Addition</div>
                  <div><kbd className="bg-white px-1 rounded">-</kbd> Subtraction</div>
                  <div><kbd className="bg-white px-1 rounded">*</kbd> Multiplication</div>
                  <div><kbd className="bg-white px-1 rounded">/</kbd> Division</div>
                  <div><kbd className="bg-white px-1 rounded">.</kbd> Decimal</div>
                  <div><kbd className="bg-white px-1 rounded">Enter</kbd> Equals</div>
                  <div><kbd className="bg-white px-1 rounded">Esc</kbd> Clear All</div>
                </div>
              </div>
            </div>
          </motion.div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="text-center p-4 bg-gray-50 rounded-lg">
              <div className="text-3xl font-mono font-bold text-blue-600 mb-2">π</div>
              <div className="text-sm text-gray-600">Pi (3.14159...)</div>
              <div className="text-xs text-gray-500">Ratio of circumference to diameter</div>
            </div>
            <div className="text-center p-4 bg-gray-50 rounded-lg">
              <div className="text-3xl font-mono font-bold text-green-600 mb-2">e</div>
              <div className="text-sm text-gray-600">Euler's Number (2.71828...)</div>
              <div className="text-xs text-gray-500">Base of natural logarithm</div>
            </div>
            <div className="text-center p-4 bg-gray-50 rounded-lg">
              <div className="text-3xl font-mono font-bold text-purple-600 mb-2">√</div>
              <div className="text-sm text-gray-600">Square Root</div>
              <div className="text-xs text-gray-500">Find the principal square root</div>
            </div>
          </div>
        </motion.div>
      </div>
